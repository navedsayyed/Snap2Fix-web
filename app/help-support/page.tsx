      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-12">
        <div className="bg-[#1A1A1A] border border-white/10 rounded-3xl p-8 md:p-12">
          ...
          <div className="mt-12">
            ...
            <p className="text-gray-400 mb-6">We're here to help you</p>

            <div className="space-y-4">
              {/* Email Support Card */}
              <a
                href="mailto:snap2fix.official@gmail.com?subject=Snap2Fix Support Request"
                className="flex items-center gap-4 bg-[#2A2A2A] hover:bg-[#333333] rounded-2xl p-5 transition-all duration-300 border border-white/5 hover:border-[#00BFFF]/30 group"
              >
                <div className="w-12 h-12 rounded-full bg-[#00BFFF]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#00BFFF]/20 transition-colors">
                  <svg
                    width="24"
                    height="24"
                    fill="none"
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#00BFFF] text-sm">snap2fix.official@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#00BFFF] text-sm">+91 9356559922</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="bg-[#2A2A2A] rounded-2xl overflow-hidden border border-white/5">
              {faqs.map((faq, index) => (
                <div
                  key={faq.id}
                  className={`${
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center gap-3 p-5 text-left hover:bg-[#333333] transition-colors"
                  >
                    <svg
                      width="20"
                      height="20"
          ...
          {/* Info Box */}
          <div className="mt-12 bg-[#00BFFF]/5 border-l-4 border-[#00BFFF] rounded-2xl p-6">
