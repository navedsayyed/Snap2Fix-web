                ...
                <div className="relative" ref={timelineRef}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        ...
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/1.webp" alt="Step 1" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block order-1">
                            <Image src="/animation/1.webp" alt="Step 1" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" priority />
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/2.webp" alt="Step 2" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block">
                            <Image src="/animation/2.webp" alt="Step 2" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/3.webp" alt="Step 3" width={800} height={600} className="w-full" />
                            <div className="p-5">
                                <h3 className="text-lg font-bold text-white">Step 3: Fill Details</h3>
                            </div>
                        </div>
                        <div className="hidden lg:block order-1">
                            <Image src="/animation/3.webp" alt="Step 3" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                        <div className="hidden lg:block order-2 relative">
                            <div className="bg-[#1A1A1A] border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/4.webp" alt="Step 4" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block">
                            <Image src="/animation/4.webp" alt="Step 4" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/5.webp" alt="Step 5" width={800} height={600} className="w-full" />
                            <div className="p-5">
                                <h3 className="text-lg font-bold text-white">Step 5: Submit Complaint</h3>
                            </div>
                        </div>
                        <div className="hidden lg:block order-1">
                            <Image src="/animation/5.webp" alt="Step 5" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                        <div className="hidden lg:block order-2 relative">
                            <div className="bg-[#1A1A1A] border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/6.webp" alt="Step 6" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block">
                            <Image src="/animation/6.webp" alt="Step 6" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/7.webp" alt="Step 7" width={800} height={600} className="w-full" />
                            <div className="p-5">
                                <h3 className="text-lg font-bold text-white">Step 7: Assignment to Technician</h3>
                            </div>
                        </div>
                        <div className="hidden lg:block order-1">
                            <Image src="/animation/7.webp" alt="Step 7" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                        <div className="hidden lg:block order-2 relative">
                            <div className="bg-[#1A1A1A] border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/8.webp" alt="Step 8" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block">
                            <Image src="/animation/8.webp" alt="Step 8" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-[#1A1A1A] border border-white/10 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/9.webp" alt="Step 9" width={800} height={600} className="w-full" />
                            <div className="p-5">
                                <h3 className="text-lg font-bold text-white">Step 9: Issue Resolved</h3>
                            </div>
                        </div>
                        <div className="hidden lg:block order-1">
                            <Image src="/animation/9.webp" alt="Step 9" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                        <div className="hidden lg:block order-2 relative">
                            <div className="bg-[#1A1A1A] border border-white/10 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-20 items-center">
                        <div className="lg:hidden bg-gradient-to-br from-[#1A3A1A] to-[#1A1A1A] border border-[#00FF00]/30 rounded-2xl overflow-hidden ml-10">
                            <Image src="/animation/10.webp" alt="Step 10" width={800} height={600} className="w-full" />
                            <div className="p-5">
                        ...
                        <div className="hidden lg:block">
                            <Image src="/animation/10.webp" alt="Step 10" width={500} height={375} className="w-full max-w-md mx-auto rounded-2xl shadow-2xl border border-white/10" />
                        </div>
                    </div>
                </div>
            </main>
