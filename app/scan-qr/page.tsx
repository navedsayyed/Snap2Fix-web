            ...
            <div className="fixed top-0 left-0 right-0 bottom-0 pt-20">
                ...
                {error && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/95 p-4">
                        <div className="bg-gradient-to-br from-[#1E1E1E] to-[#252525] border border-red-500/30 rounded-xl p-6 max-w-sm text-center shadow-2xl">
                            ...
                            <div className="text-left space-y-3 mb-4">
                                <div className="bg-[#1A1A1A] border border-white/10 rounded-lg p-3">
                                    <h4 className="text-sm text-white font-semibold mb-1 flex items-center gap-2">
                                ...
                                <div className="bg-[#1A1A1A] border border-white/10 rounded-lg p-3">
                                    ...
                                    <p className="text-xs text-gray-400">
                                        Use Google Lens or phone camera app
                                    </p>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full px-5 py-2.5 bg-gradient-to-r from-[#00BFFF] to-[#0099CC] hover:from-[#00BFFF]/90 hover:to-[#0099CC]/90 text-white text-sm font-semibold rounded-lg transition-all duration-300 shadow-lg mb-2"
                            >
                                Try Again
                            </button>
                            ...
                            <button
                                onClick={() => router.push('/')}
                                className="w-full px-5 py-2.5 bg-[#2A2A2A] hover:bg-[#333333] text-white text-sm font-semibold rounded-lg transition-all duration-300"
                            >
                                Go Back
                            </button>
                        </div>
